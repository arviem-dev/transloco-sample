...
import { IgxGridModule, IgxNavbarModule, IgxSelectModule } from 'igniteui-angular';
...
@NgModule({
  declarations: [AppComponent, NavbarComponent, NormalIgxGridComponent, TranslocoIgxGridComponent],
  imports: [
    BrowserModule,
