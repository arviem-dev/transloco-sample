...
export class TranslocoIgxGridComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('myGrid', { static: false }) private readonly grid: IgxGridComponent;
  private readonly destroy$ = new Subject<boolean>();
  readonly gridData = gridDummyData;

  constructor(private readonly translocoService: TranslocoService, private readonly cdr: ChangeDetectorRef) {}
